                ...
                <div class="col-md-8 col-xl-6">
                    <div class="card mb-5">
                        <div class="card-body text-center d-flex flex-column align-items-center bg-dark" style="color: white;border: 5px solid">
                            <form class="text-center" method="post" action="{{route('modify', ['id' => $dog->id])}}">
                                @csrf
                                <label class="form-label">NOMBRE</label>
                                <input name="name" class="form-control" type="text" value="{{$dog->name}}" required />
                                <label class="form-label">FECHA DE NACIMIENTO</label>
                                <input name="date_of_birth" class="form-control" type="date" value="{{dog->date_of_birth}}" required/>
                                <label class="form-label">SEXO</label>
                                <div class="form-check" required>
                                    <input id="formCheck-1" name="sex" value="Macho" class="form-check-input" type="radio" style="margin-left: 44px;" value="{{$dog->sex}}" />
                                    <label class="form-check-label" for="formCheck-1">M</label>
                                </div>
                                <div class="form-check">
                                    <input id="formCheck-2" name="sex" value="Hembra" class="form-check-input" type="radio" style="margin-left: 44px;" value="{{$dog->sex}}" />
                                    <label class="form-check-label" for="formCheck-2">H</label>
                                </div>
                                <label class="form-label">RAZA</label>
                                <input class="form-control" type="text" name="breed" value="{{$dog->breed}}" required/>
                                <label class="form-label">PROPIETARIO</label>
                                <input class="form-control" type="text" name="owner" required/>
                                <label class="form-label">ALTURA</label>
                                <input class="form-control" type="text" name="height" value="{{$dog->height}}" required/>
                                <label class="form-label">PESO</label>
                                <input class="form-control" type="text" name="weight" value="{{$dog->weight}}" required/>
                                <label class="form-label">PRUEBAS DE SALUD</label>
                                <textarea class="form-control" name="health_tests" value="{{$dog->health_tests}}"></textarea>
