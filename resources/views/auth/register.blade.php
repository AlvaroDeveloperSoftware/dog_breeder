            ...
            <section class="position-relative py-4 py-xl-5"><div class="container" style="background: #dd2e44a6;">
                <div class="row d-flex justify-content-center" style="background: #d0bbbb;">
                    <div class="col-md-6 col-xl-4">
                        ...
                        <a href="{{route('register.view')}}" class="btn btn-primary" type="button" style="background: #91686d;border-style: none;color: #65120d;text-align: center;font-size: 18px;">REGISTRARME COMO CRIADOR</a>
